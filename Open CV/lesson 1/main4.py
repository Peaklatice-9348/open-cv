...
image1 = cv2.imread('lesson 1/download (1).jpg',cv2.IMREAD_UNCHANGED)
image2 = cv2.imread('lesson 1/download (2).jpg',cv2.IMREAD_UNCHANGED)
...
'''
#subtraction
image3 = cv2.imread('images/newimage.png',cv2.IMREAD_UNCHANGED)
...
#image resizing
image_new = cv2.imread('lesson 1/kirby.jpg',1)
cv2.imshow('image not new',image_new)
resized = cv2.resize(image_new,(500,500))
cv2.imshow('new image not new',resized)
cv2.waitKey(0)